        ...
        public void readFromFile(string filename) 
        {
            try
            {
                ...
                while (!read.EndOfStream)
                {
                    ...
                    switch (values[0])
                    {
                        case "DressShirt": //values[0], values[1], values[2], Convert.ToDouble(values[3]), Convert.ToInt32(values[3]),
                            this.AddProduct(new DressShirt(values[0], values[1], values[2], Convert.ToDouble(values[3]), Convert.ToInt32(values[4]), values[5], values[6], values[7], Convert.ToInt32(values[8]), Convert.ToInt32(values[9])));
                            break;
                        case "Pants":
                            this.AddProduct(new Pants(values[0], values[1], values[2], Convert.ToDouble(values[3]), Convert.ToInt32(values[4]), values[5], values[6], values[7], Convert.ToInt32(values[8]), Convert.ToInt32(values[9])));
                            break;
                        case "TShirt":
                        ...
                        case "Movie":
                            ...
                            break;
                        case "Music":
                            this.AddProduct(new Music(values[0], values[1], values[2], Convert.ToDouble(values[3]), Convert.ToInt32(values[4]), Convert.ToDateTime(values[5]), Convert.ToInt32(values[6]), Convert.ToInt32(values[7]), values[8], TimeSpan.Parse(values[9]), values[10], values[11], values[12]));
                            break;
                    }
                }
            }
